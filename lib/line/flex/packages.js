      ...
      contents: [
        {
          ...
          contents: [
            ...
            {
              type: 'text', text: pkg.badge, size: 'xxs', color: pkg.color,
              weight: 'bold', align: 'center',
              decoration: 'none',
              background: { type: 'linearGradient', angle: '0deg', startColor: '#FFFFFF', endColor: '#FFFFFF' },
              offsetTop: '2px',
            },
          ],
          alignItems: 'center',
        },
        { type: 'text', text: pkg.rooms, size: 'xs', color: '#FFFFFFCC', margin: 'sm' },
      ],
    },
    body: {
      type: 'box',
