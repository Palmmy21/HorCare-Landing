...
const BLOG_ARTICLES = [
  { slug: 'how-dormitory-management-saves-time', title: 'ระบบจัดการหอพักช่วยให้ประหยัดเวลาได้ยังไง? (คู่มือออกบิลเร็วใน 30 วินาที)', desc: 'เจาะลึกวิธีตัดภาระงานสิ้นเดือน เปลี่ยนจากการนั่งกดเครื่องคิดเลข 3 วันเต็ม มาเป็นออกบิลและแจ้งเตือน LINE อัตโนมัติใน 30 วินาที แม้ไม่ถนัดคอมพิวเตอร์', dateISO: '2026-07-01' },
